      ...
      <div className="about">
        <div className="about-page">
          ...
          <div className="about-body">
            ...
            <p>i really want to pursue programming. i want to work on environment where i can  learn more knowledge and grow as person. i want to do the best that i can to benefit the company and the team i will be part of.</p>
          </div>
        </div>
      </div>
    </>
